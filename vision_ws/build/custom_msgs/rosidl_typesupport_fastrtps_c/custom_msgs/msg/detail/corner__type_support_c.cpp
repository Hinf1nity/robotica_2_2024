...
#include "custom_msgs/msg/detail/corner__rosidl_typesupport_fastrtps_c.h"
...
using _Corner__ros_msg_type = custom_msgs__msg__Corner;
...
static uint32_t _Corner__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__Corner(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs__msg__Corner;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
static size_t _Corner__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__msg__Corner(
