...
#include "custom_msgs/msg/detail/box__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const custom_msgs::msg::Corner &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  custom_msgs::msg::Corner &);
size_t get_serialized_size(
  const custom_msgs::msg::Corner &,
  size_t current_alignment);
size_t
...
// functions for custom_msgs::msg::Corner already declared above
...
cdr_serialize(
  const custom_msgs::msg::Box & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::Box & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: centre
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Corner(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs::msg::Box;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::Box *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::Box *>(
    untyped_ros_message);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_Box__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, Box)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_Box__handle;
}
