...
bool custom_msgs__msg__box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // centre
    ...
    if (!custom_msgs__msg__corner__convert_from_py(field, &ros_message->centre)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // corners
    ...
    if (!custom_msgs__msg__Corner__Sequence__init(&(ros_message->corners), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create custom_msgs__msg__Corner__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    custom_msgs__msg__Corner * dest = ros_message->corners.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!custom_msgs__msg__corner__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * custom_msgs__msg__box__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._box");
  ...
  {  // corners
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = custom_msgs__msg__corner__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
