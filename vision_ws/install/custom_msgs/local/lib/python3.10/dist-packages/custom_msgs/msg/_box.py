...
class Box(metaclass=Metaclass_Box):
    ...
    def centre(self, value):
        if __debug__:
            from custom_msgs.msg import Corner
            assert \
                isinstance(value, Corner), \
                "The 'centre' field must be a sub message of type 'Corner'"
        self._centre = value
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, Corner) for v in value) and
                 True), \
                "The 'corners' field must be a set or sequence and each value of type 'Corner'"
        self._corners = value
