...
{
  new (message_memory) custom_msgs::msg::Corner(_init);
}

void Corner_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_msgs::msg::Corner *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Corner_message_member_array[2] = {
  {
    ...
    offsetof(custom_msgs::msg::Corner, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs::msg::Corner, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::Corner_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msgs, msg, Corner)() {
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::Corner_message_type_support_handle;
}
